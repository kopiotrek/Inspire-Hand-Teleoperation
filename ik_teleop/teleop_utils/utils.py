...
def read_camera_parameters(camera_id):
    ...
    inf = open('config/c' + str(camera_id) + '.dat', 'r')
    # inf = open('teleop_utils/config/c' + str(camera_id) + '.dat', 'r')
...
# def read_rotation_translation(camera_id, savefolder = 'teleop_utils/config/'):
def read_rotation_translation(camera_id, savefolder = 'config/'):
